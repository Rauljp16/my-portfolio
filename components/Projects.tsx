  ...
  return (
    ...
    >
      ...
      <div className="slider overflow-hidden">
        ...
        <article className="childFocus slides  bg-[url('/images/projects/miranda.webp')] ">
      ...
      <article className="absolute bottom-28 flex gap-10 z-20">
        <button
          className="w-14 h-10 flex bg-background-dark/70 justify-center items-center hover:scale-110 border-[1px] border-goldDark rounded-xl transition duration-700 ease-in-out"
          onClick={handlePrev}
        >
